...
public class JellyWebApplicationInitializer implements WebApplicationInitializer {
    ...
    private void registerFilters(ServletContext container, WebApplicationContext ctx) {
        ...
        registerFilter(container, ctx.getBean(DruziFilter.class));
    ...
    private ConfigurableSiteMeshFilter buildConfigurableSiteMeshFilter() {
        return new ConfigurableSiteMeshFilter() {
            ...
            protected void applyCustomConfiguration(SiteMeshFilterBuilder builder) {
                ...
                builder.addDecoratorPath("/edit/*", "/WEB-INF/template/edit-template.jsp" );
                builder.addDecoratorPath("/edit", "/WEB-INF/template/edit-template.jsp" );
                builder.addDecoratorPath("/register" , "/WEB-INF/template/register-template.jsp");
                builder.addDecoratorPath("/login" , "/WEB-INF/template/register-template.jsp");
